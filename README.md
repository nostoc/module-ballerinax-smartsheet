...
public function main() returns error? {
    smartsheet:Folder newFolder = {
        name: "Project Documents"
    };

    smartsheet:SharedSecretResponse response = check smartsheetClient->/folders/[123456789]/folders.post(newFolder);
}
```
...
2. [Project workspace initialization](https://github.com/ballerina-platform/module-ballerinax-smartsheet/tree/main/examples/project-workspace-initialization) - Illustrates setting up a complete project workspace with sheets and initial configurations.
3. [Project health monitoring](https://github.com/ballerina-platform/module-ballerinax-smartsheet/tree/main/examples/project-health-monitoring) - Shows how to monitor and track project health metrics using Smartsheet data.
4. [Project collaboration audit](https://github.com/ballerina-platform/module-ballerinax-smartsheet/tree/main/examples/project-collaboration-audit) - Demonstrates auditing and tracking collaboration activities within Smartsheet projects.

...
public function main() returns error? {
    smartsheet:GroupCreate1 newGroup = {
        name: "Project Team",
        description: "Team for managing project tasks",
        members: [
...
2. [Sheet collaboration workflow](https://github.com/ballerina-platform/module-ballerinax-smartsheet/tree/main/examples/sheet-collaboration-workflow) - Illustrates managing collaborative workflows and permissions for sheets.
3. [Project collaboration reporting](https://github.com/ballerina-platform/module-ballerinax-smartsheet/tree/main/examples/project-collaboration-reporting) - Shows how to generate collaborative project reports and analytics.
